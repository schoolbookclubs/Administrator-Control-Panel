...
export function DataContextFunction({ children }) {
  ...
  const fetchSchools = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get('https://school-book-clubs-backend.vercel.app/api/school');
  ...
  const getTeacherRatings = useCallback(async (schoolCode) => {
    ...
    try {
      const response = await axios.get(
        `https://school-book-clubs-backend.vercel.app/api/RateTeacher/oneschool/${schoolCode}/Teachersratings`
      );
  ...
  const getStudentBookRatings = useCallback(async (schoolCode) => {
    try {
      const response = await axios.get(
        `https://school-book-clubs-backend.vercel.app/api/RateingStudentBook/RateingStudentBookbyschoolcode/${schoolCode}`
      );
      return response.data;
    } catch (error) {
  ...
  const getStudentSelfAssessments = useCallback(async (schoolCode) => {
    try {
      const response = await axios.get(
        `https://school-book-clubs-backend.vercel.app/api/StudentSelfAssessment/oneschool/${schoolCode}/StudentsSelfAssessments`
      );
      return response.data;
    } catch (error) {
  ...
  const getReadingClubEvaluations = useCallback(async (schoolCode) => {
    try {
      const response = await axios.get(
        `https://school-book-clubs-backend.vercel.app/api/ReadingClubEvaluation/oneschool/${schoolCode}/ReadingClubEvaluations`
      );
      return response.data;
    } catch (error) {
